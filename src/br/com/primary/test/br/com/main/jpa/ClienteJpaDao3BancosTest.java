...
import br.com.primary.main.dao.jpa.ClienteJpaDB3DAO;
...
public class ClienteJpaDao3BancosTest {
    ...
    public void end() throws DaoException {
        ...
        Collection<ClienteJpa2> list3 = clienteDB3Dao.showAll();
        excluir3(list3);
    }
    ...
    public void pesquisarCliente() throws TypeKeyNotFoundException, DaoException, MoreThanOneRegisterException, TableException {
        ...
        clienteDB3Dao.add(cliente2);

        ClienteJpa2 clienteConsultado3 = clienteDB3Dao.show(cliente2.getId());
