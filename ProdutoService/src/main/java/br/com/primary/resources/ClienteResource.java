package br.com.primary.resources;
...
import br.com.primary.usecase.BuscaCliente;
import br.com.primary.usecase.CadastroCliente;
...
public class ClienteResource {
    ...
    public ResponseEntity<Cliente> cadastrar(@RequestBody @Valid Clinete cliente) {
        return ResponseEntity.ok(cadastroCliente.cadastrar(cliente));
    }

    @PutMapping
    @Operation(summary = "Atualiza os dados do cliente")
    public ResponseEntity<Cliente> atualizar(@RequestBody @Valid Clinete cliente) {
